...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 w-full border-b border-gray-200 dark:border-stone-500 bg-white/90 dark:bg-neutral-800 backdrop-blur transition-colors duration-500 z-[3000]">
